    ...
    <FlexContainer>
      <VerticalFlexBox>
        ...
        <p>
          ...
          through weekly standups and frequent check-ins. In addition to these responsibilities, I
          had the privilege to implement key interactive elements, including the following:
        </p>
        <br />
    ...
    <FlexContainer>
      <VerticalFlexBox>
        ...
        <p>
          ...
          player. As the user gets closer to the next letter, the ghost vibrates the planchette with
          a greater intensity. Through this haptic feedback, users are guided to the correct
        ...
        <p>
          ...
          interactions posed a challenge because this script removes positional constraints on held
          objects. To avoid the removal of these necessary constraints, I hid the Grab Interactable
          object's mesh and replaced it with a replica planchette. From there, I used the positional
          data of the holding controller and bound the replica planchette on the y-axis within the
          Ouija board. To provide the sense that the ghosts were keeping the planchette in place, I
          also implemented a solution where the planchette glides back to its original position if
          the holding controller goes out-of-bounds (See
    ...
    <FlexContainer>
      <VerticalFlexBox>
        ...
        <p>
          ...
          Once the player makes progress towards their escape, several changes are seen to give this
          illusion. The clock's hands shift to the next quarter-hour, and a loud clock chime is
          heard. Dr. Montgomery's portrait becomes younger until distortion overcomes the image. In
          stealing their essence, he also causes the player's hands to age.
        </p>
        <h4>Challenges.</h4>
        <p>
